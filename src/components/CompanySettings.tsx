...
const CompanySettings: React.FC<CompanySettingsProps> = ({ settings, onUpdate }) => {
  ...
  return (
    <div className="p-4 md:p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2">
          🚀 How to Deploy & Use Online
        </h2>
        
        <div className="space-y-6">
          {/* Option 1 */}
          <div className="border rounded-xl p-5 bg-gradient-to-r from-blue-50 to-blue-100">
            <h3 className="text-lg font-bold text-blue-800 mb-3">Option 1: Netlify (Recommended - FREE)</h3>
            <ol className="list-decimal list-inside space-y-2 text-gray-700">
              <li>Go to <a href="https://netlify.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">netlify.com</a> and sign up (free)</li>
              <li>Click "Add new site" → "Deploy manually"</li>
              <li>Drag and drop your <code className="bg-white px-2 py-0.5 rounded">dist</code> folder</li>
              <li>Your app is live! Get a free URL like <code className="bg-white px-2 py-0.5 rounded">your-app.netlify.app</code></li>
              <li>Optional: Connect your custom domain (e.g., fleet.yourcompany.com)</li>
            </ol>
          </div>

          {/* Option 2 */}
          <div className="border rounded-xl p-5 bg-gradient-to-r from-green-50 to-green-100">
            <h3 className="text-lg font-bold text-green-800 mb-3">Option 2: Vercel (FREE)</h3>
            <ol className="list-decimal list-inside space-y-2 text-gray-700">
              <li>Go to <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="text-green-600 underline">vercel.com</a> and sign up (free)</li>
              <li>Click "Add New Project"</li>
              <li>Import from GitHub or upload manually</li>
              <li>Click Deploy - done!</li>
              <li>Get URL like <code className="bg-white px-2 py-0.5 rounded">your-app.vercel.app</code></li>
            </ol>
          </div>

          {/* Option 3 */}
          <div className="border rounded-xl p-5 bg-gradient-to-r from-purple-50 to-purple-100">
            <h3 className="text-lg font-bold text-purple-800 mb-3">Option 3: GitHub Pages (FREE)</h3>
            <ol className="list-decimal list-inside space-y-2 text-gray-700">
              <li>Create a GitHub account if you don't have one</li>
              <li>Create a new repository</li>
              <li>Upload your <code className="bg-white px-2 py-0.5 rounded">dist</code> folder contents</li>
              <li>Go to Settings → Pages → Select "main" branch</li>
              <li>Your app is live at <code className="bg-white px-2 py-0.5 rounded">username.github.io/repo-name</code></li>
            </ol>
          </div>

          {/* Option 4 */}
          <div className="border rounded-xl p-5 bg-gradient-to-r from-amber-50 to-amber-100">
            <h3 className="text-lg font-bold text-amber-800 mb-3">Option 4: Firebase Hosting (FREE)</h3>
            <ol className="list-decimal list-inside space-y-2 text-gray-700">
              <li>Go to <a href="https://console.firebase.google.com" target="_blank" rel="noopener noreferrer" className="text-amber-600 underline">Firebase Console</a></li>
              <li>Create a new project</li>
              <li>Go to Hosting → Get Started</li>
              <li>Install Firebase CLI: <code className="bg-white px-2 py-0.5 rounded">npm install -g firebase-tools</code></li>
              <li>Run: <code className="bg-white px-2 py-0.5 rounded">firebase login && firebase init && firebase deploy</code></li>
            </ol>
          </div>

          {/* Quick Export */}
          <div className="border-2 border-dashed border-gray-300 rounded-xl p-5 bg-gray-50">
            <h3 className="text-lg font-bold text-gray-800 mb-3">📥 Quick Export for Local Use</h3>
            <p className="text-gray-600 mb-3">
              After building, your complete app is in the <code className="bg-white px-2 py-0.5 rounded">dist</code> folder. 
              You can copy this folder to any computer or USB drive and open <code className="bg-white px-2 py-0.5 rounded">index.html</code> directly in a browser.
            </p>
            <div className="bg-gray-800 text-green-400 rounded-lg p-4 font-mono text-sm">
              <p>$ npm run build</p>
              <p>$ cd dist</p>
              <p>$ # Copy index.html and assets folder anywhere!</p>
            </div>
          </div>

          {/* Firebase Cloud Setup */}
          <div className="border rounded-xl p-5 bg-gradient-to-r from-orange-50 to-red-50">
            <h3 className="text-lg font-bold text-orange-800 mb-3">🔥 Firebase Cloud Sync (Recommended)</h3>
            <p className="text-gray-700 mb-4">
              Set up Firebase to sync data across all your devices in real-time!
            </p>
            <ol className="list-decimal list-inside space-y-2 text-gray-700 text-sm">
              <li>Go to <a href="https://console.firebase.google.com" target="_blank" rel="noopener noreferrer" className="text-orange-600 underline">Firebase Console</a></li>
              <li>Click "Add project" → name it "brm-fleet"</li>
              <li>Go to Project Settings → Your apps → Web ({"</>"})</li>
              <li>Register app and copy the config</li>
              <li>Go to Build → Realtime Database → Create Database</li>
              <li>Choose region and start in "Test mode"</li>
              <li>Create a <code className="bg-white px-2 py-0.5 rounded">.env</code> file in your project root:</li>
            </ol>
            <div className="bg-gray-800 text-green-400 rounded-lg p-4 font-mono text-xs mt-4 overflow-x-auto">
              ...
              <p>VITE_FIREBASE_DATABASE_URL=https://your-project.firebaseio.com</p>
              <p>VITE_FIREBASE_APP_ID=your_app_id</p>
            </div>
            <p className="text-sm text-orange-700 mt-3">
              ✅ Once configured, data will sync automatically across all devices!
            </p>
          </div>
          ...
          <div className="bg-green-50 border-l-4 border-green-400 p-4 rounded-r-lg">
            ...
            <p className="text-green-700 text-sm">
              Your app supports both offline and cloud modes:
            </p>
            <ul className="list-disc list-inside text-green-700 text-sm mt-2 space-y-1">
              <li><strong>Without Firebase:</strong> Data stored locally in browser (works offline)</li>
              <li><strong>With Firebase:</strong> Data syncs to cloud and works across all devices</li>
              <li>Local backup is always maintained even with cloud sync</li>
              <li>Check the sync status indicator in the header</li>
            </ul>
          </div>
        </div>
      </div>
